...
labels = [
    ...
    Label(  'out of roi'           ,  3 ,      2 , 'void'            , 0       , False        , True         , (  0,  0,  0) ),
    ...
    Label(  'rail track'           , 10 ,      5 , 'flat'            , 1       , False        , True         , (230,150,140) ),
    Label(  'building'             , 11 ,      6 , 'construction'    , 2       , False        , False        , ( 70, 70, 70) ),
    Label(  'wall'                 , 12 ,    255 , 'construction'    , 2       , False        , False        , (102,102,156) ),
    Label(  'fence'                , 13 ,      7 , 'construction'    , 2       , False        , False        , (190,153,153) ),
    Label(  'guard rail'           , 14 ,      8 , 'construction'    , 2       , False        , True         , (180,165,180) ),
    Label(  'bridge'               , 15 ,    255 , 'construction'    , 2       , False        , True         , (150,100,100) ),
    Label(  'tunnel'               , 16 ,      9 , 'construction'    , 2       , False        , True         , (150,120, 90) ),
    ...
    Label(  'terrain'              , 22 ,     11 , 'nature'          , 4       , False        , False        , (152,251,152) ),
    Label(  'sky'                  , 23 ,     12 , 'sky'             , 5       , False        , False        , ( 70,130,180) ),
    ...
    Label(  'bicycle'              , 34 ,    255 , 'vehicle'         , 7       , True         , False        , (119, 11, 32) ),
    Label(  'bicycle'              , 35 ,     17 , 'vehicle'         , 7       , True         , False        , (119, 11, 32) ),
    Label(  'bicycle'              , 36 ,    255 , 'vehicle'         , 7       , True         , False        , (119, 11, 32) ),
    Label(  'bicycle'              , 37 ,    255 , 'vehicle'         , 7       , True         , False        , (119, 11, 32) ),
    Label(  'bicycle'              , 38 ,    255 , 'vehicle'         , 7       , True         , False        , (119, 11, 32) ),
    Label(  'bicycle'              , 39 ,    255 , 'vehicle'         , 7       , True         , False        , (119, 11, 32) ),
    Label(  'bicycle'              , 40 ,     18 , 'vehicle'         , 7       , True         , False        , (119, 11, 32) ),
    Label(  'bicycle'              , 41 ,     19 , 'vehicle'         , 7       , True         , False        , (119, 11, 32) ),
    Label(  'bicycle'              , 42 ,     20 , 'vehicle'         , 7       , True         , False        , (119, 11, 32) ),
    Label(  'bicycle'              , 43 ,     21 , 'vehicle'         , 7       , True         , False        , (119, 11, 32) ),
    Label(  'bicycle'              , 44 ,     22 , 'vehicle'         , 7       , True         , False        , (119, 11, 32) ),
    Label(  'bicycle'              , 45 ,     23 , 'vehicle'         , 7       , True         , False        , (119, 11, 32) ),
    Label(  'bicycle'              , 46 ,     24 , 'vehicle'         , 7       , True         , False        , (119, 11, 32) ),
    Label(  'bicycle'              , 47 ,     25 , 'vehicle'         , 7       , True         , False        , (119, 11, 32) ),
    Label(  'bicycle'              , 48 ,     26 , 'vehicle'         , 7       , True         , False        , (119, 11, 32) ),
    Label(  'bicycle'              , 49 ,    255 , 'vehicle'         , 7       , True         , False        , (119, 11, 32) ),
    Label(  'bicycle'              , 50 ,     27 , 'vehicle'         , 7       , True         , False        , (119, 11, 32) ),
